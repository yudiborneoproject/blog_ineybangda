		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
                        <a href="index.html" class="logo"><img src="{{ asset('frontend/img/inacon1.png') }}" alt=""></a>
					</div>
					<!-- /logo -->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Gayuh Upayani | Lagi Naik Gula Darah & Tensi Darah tidak Normal</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</div>
				</div>
			</div>
